...
def main(_):
    train_imgs = r'Y:\MRI Applications Laboratory\ABTI_clean_files\abti_train_images.h5'
    train_annos = r'Y:\MRI Applications Laboratory\ABTI_clean_files\abti_train_annos.h5'
    valid_imgs = r'Y:\MRI Applications Laboratory\ABTI_clean_files\abti_validation_images.h5'
    valid_annos = r'Y:\MRI Applications Laboratory\ABTI_clean_files\abti_validation_annos.h5'
    test_imgs = r'Y:\MRI Applications Laboratory\ABTI_clean_files\abti_test_images_1.h5'
    ckpt_dir = r'Y:\MRI Applications Laboratory\ABTI_clean_files\ninth_run'
    # ckpt_dir = './abti_ckpt'
    preds_file_name = r'Y:\MRI Applications Laboratory\ABTI_clean_files\abti_test_preds_1.h5'
    # load_ckpt = False
    load_ckpt = True
    # dl_action = 'train'
    dl_action = 'test'
