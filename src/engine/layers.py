...
# from keras.layers import Input, ZeroPadding2D, MaxPooling2D, Conv2D, Activation, BatchNormalization, Concatenate, UpSampling2D, Flatten, GlobalAvgPool2D, Dense
...
# model.summary()
# plot_model(model, r'C:\Users\jsanders1\Desktop\test_model.png', show_shapes=True)
