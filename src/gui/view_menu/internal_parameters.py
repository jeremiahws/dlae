...
class InternalParameters:
    def __init__(self, controller):
        ...
        self.l_to_categorical = tk.Label(self.tl_parameters, text='Convert to categorical:').grid(row=9, column=0, sticky=tk.N+tk.S+tk.E+tk.W)
        self.l_to_categorical_s = tk.Label(self.tl_parameters, textvariable=self.controller.data_menu.bool_to_categorical).grid(row=9, column=1, sticky=tk.N+tk.S+tk.E+tk.W)
        self.l_num_categories = tk.Label(self.tl_parameters, text='Number of categories:').grid(row=10, column=0, sticky=tk.N+tk.S+tk.E+tk.W)
        self.l_num_categories_s = tk.Label(self.tl_parameters, textvariable=self.controller.data_menu.s_num_categories).grid(row=10, column=1, sticky=tk.N+tk.S+tk.E+tk.W)
        ...
        self.l_repeatX = tk.Label(self.tl_parameters, text='Repeat X along channels:').grid(row=12, column=0, sticky=tk.N+tk.S+tk.E+tk.W)
        self.l_repeatX_s = tk.Label(self.tl_parameters, textvariable=self.controller.data_menu.bool_repeatX).grid(row=12, column=1, sticky=tk.N+tk.S+tk.E+tk.W)
        self.l_repeatX_num = tk.Label(self.tl_parameters, text='Number of X repetitions:').grid(row=13, column=0, sticky=tk.N+tk.S+tk.E+tk.W)
        self.l_repeatX_num_s = tk.Label(self.tl_parameters, textvariable=self.controller.data_menu.s_repeatX).grid(row=13, column=1, sticky=tk.N+tk.S+tk.E+tk.W)
        ...
        self.l_augmentation_rounds = tk.Label(self.tl_parameters, text='Augmentation rounds:').grid(row=17, column=8, sticky=tk.N+tk.S+tk.E+tk.W)
        self.l_augmentation_rounds_s = tk.Label(self.tl_parameters, textvariable=self.controller.data_menu.s_rounds).grid(row=17, column=9, sticky=tk.N+tk.S+tk.E+tk.W)
        self.l_augmentation_seed = tk.Label(self.tl_parameters, text='Random seed:').grid(row=18, column=8, sticky=tk.N+tk.S+tk.E+tk.W)
        self.l_augmentation_seed_s = tk.Label(self.tl_parameters, textvariable=self.controller.data_menu.s_random_seed).grid(row=18, column=9, sticky=tk.N+tk.S+tk.E+tk.W)
        self.l_zca_epsilon = tk.Label(self.tl_parameters, text='ZCA epsilon:').grid(row=19, column=8, sticky=tk.N+tk.S+tk.E+tk.W)
        self.l_zca_epsilon_s = tk.Label(self.tl_parameters, textvariable=self.controller.data_menu.s_zca_epsilon).grid(row=19, column=9, sticky=tk.N+tk.S+tk.E+tk.W)
