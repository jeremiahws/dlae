...
class GuiParameterController(object):
    ...
    def get_configs(self):
        ...
        configs['preprocessing']['reshape_X_switch'] = str(self.data_menu.bool_reshapeX.get())
        configs['preprocessing']['reshape_X_dimensions'] = self.data_menu.s_reshapeX.get()
        configs['preprocessing']['permute_X_switch'] = str(self.data_menu.bool_permuteX.get())
        configs['preprocessing']['permute_X_dimensions'] = self.data_menu.s_permuteX.get()
        ...
        configs['preprocessing']['reshape_y_switch'] = str(self.data_menu.bool_reshapeY.get())
        configs['preprocessing']['reshape_y_dimensions'] = self.data_menu.s_reshapeY.get()
        configs['preprocessing']['permute_y_switch'] = str(self.data_menu.bool_permuteY.get())
        configs['preprocessing']['permute_y_dimensions'] = self.data_menu.s_permuteY.get()
    ...
    def set_configs(self, configs):
        ...
        self.data_menu.bool_reshapeX.set(configs['preprocessing']['reshape_X_switch'])
        self.data_menu.s_reshapeX.set(configs['preprocessing']['reshape_X_dimensions'])
        self.data_menu.bool_permuteX.set(configs['preprocessing']['permute_X_switch'])
        self.data_menu.s_permuteX.set(configs['preprocessing']['permute_X_dimensions'])
        ...
        self.data_menu.bool_reshapeY.set(configs['preprocessing']['reshape_y_switch'])
        self.data_menu.s_reshapeY.set(configs['preprocessing']['reshape_y_dimensions'])
        self.data_menu.bool_permuteY.set(configs['preprocessing']['permute_y_switch'])
        self.data_menu.s_permuteY.set(configs['preprocessing']['permute_y_dimensions'])
